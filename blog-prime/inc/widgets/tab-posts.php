    ...
    class Blog_Prime_Tab_Posts_Widget extends Blog_Prime_Widget_Base {
        ...
        function __construct() {
            ...
            $fields = array(
                ...
                'popular_title' => array(
                    'label' => esc_html__('Popular Title:', 'blog-prime'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Popular', 'blog-prime'),
                ),
                ...
                'recent_title' => array(
                    'label' => esc_html__('Recent Title:', 'blog-prime'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Recent', 'blog-prime'),
                ),
                'recent_number' => array(
                    'label'        => esc_html__('No. of Posts:', 'blog-prime'),
                    'type'         => 'number',
                ...
                'comment_title' => array(
                    'label' => esc_html__('Comment Title:', 'blog-prime'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Comments', 'blog-prime'),
                ),
                                ...
                                <div class="twp-row twp-row-sm">
                                    <div class="column column-four">
                                        <div class="article-image">
                                            <?php $featured_image = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), $params['select_image_size'] ); 
                                            $featured_image = isset( $featured_image[0] ) ? $featured_image[0] : ''; ?>
                                            <a href="<?php the_permalink();?>" class="data-bg data-bg-small" data-background="<?php echo esc_url( $featured_image ); ?>" aria-label="<?php the_title_attribute(); ?>" tabindex="0"></a>
                                        </div>
                                    </div>

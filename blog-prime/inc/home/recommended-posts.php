...
if( !function_exists('blog_prime_recommended_posts') ):
	...
	function blog_prime_recommended_posts(){
        ...
        $recommended_post_query = new WP_Query( array( 'post_type' => 'post','posts_per_page' => 3, 'category_name' => esc_html( $recommended_post_category ), 'paged'=>$c_paged ) );
			        ...
			        <div class="twp-row recommended-post-wraper">
			        	...
			        	<?php while( $recommended_post_query->have_posts() ):
				            ...
				            <div class="column column-three-1 column-five-sm recommended-load" data-mh="recommended-item"  data-aos="fade-up" data-aos-delay="300">
                                <article id="recommended-post-<?php the_ID(); ?>" <?php post_class(); ?>>
                                    <div class="post-thumb">
				                        
				                        <a href="<?php echo esc_url( get_the_permalink() ); ?>" class="data-bg data-bg-big" data-background="<?php echo esc_url( $featured_image ); ?>" aria-label="<?php the_title_attribute(); ?>" tabindex="0">

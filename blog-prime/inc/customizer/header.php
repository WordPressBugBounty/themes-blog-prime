...
$wp_customize->add_setting( 'twp_theme_general_color',
    array(
    'default'           => $default['twp_theme_general_color'],
...
$wp_customize->add_control(
    new WP_Customize_Color_Control(
        $wp_customize, 'twp_theme_general_color',
        array(
            'label' => esc_html__('General Text  Color', 'blog-prime'),
            'section' => 'colors',
            'settings' => 'twp_theme_general_color',
        ))
);


$wp_customize->add_setting('twp_theme_secondary_color',
    array(
        'default' => $default['twp_theme_secondary_color'],
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_hex_color',
    )
);
...
$wp_customize->add_control( 
    new WP_Customize_Color_Control( 
    $wp_customize, 'twp_theme_secondary_color',
    array(
        'label'      => esc_html__( 'Secondary Text Color', 'blog-prime' ),
        'section'    => 'colors',
        'settings'   => 'twp_theme_secondary_color',
    ) ) 
);
